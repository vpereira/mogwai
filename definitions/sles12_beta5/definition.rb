Veewee::Session.declare({
  ...
  :disk_format => 'VDI',
  :hostiocache => 'off',
  :iso_file => 'SLE-12-Server-DVD-x86_64-Beta5-DVD1.iso',
  :iso_src  => 'http://download.suse.de/install/SLE-12-Server-Beta5/SLE-12-Server-DVD-x86_64-Beta5-DVD1.iso',
  :iso_md5  => 'c27e3918e9d208cafeb33b968f55694a',
  ...
  :hooks => {
      ...
      :after_postinstall => Proc.new do
          `/usr/bin/VBoxManage controlvm sles12_beta4 poweroff` # hardcoded name/provider sucks! it will break if provider == kvm/libvirt
      end
  }
})
